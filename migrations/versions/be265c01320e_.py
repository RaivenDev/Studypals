...
Revision ID: be265c01320e
Revises: 
Create Date: 2023-12-25 03:37:56.447791
...
def upgrade():
    ...
    op.create_index(op.f('ix_post_subject'), 'post', ['subject'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_post_subject'), table_name='post')
    op.drop_table('post')
